...
IF (ENABLE_CARMA_C_CONTIGUOUS_MODE)
    SET(CARMA_C_CONTIGUOUS_MODE ON)
    MESSAGE(STATUS "carma: enable c-contiguous mode: ${ENABLE_CARMA_C_CONTIGUOUS_MODE}")
ELSE ()
    REMOVE_DEFINITIONS(-DCARMA_C_CONTIGUOUS_MODE)
ENDIF ()
